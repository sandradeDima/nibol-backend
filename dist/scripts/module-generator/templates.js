...
export const renderBackendPermissionsTemplate = (names) => {
...
export const renderBackendSchemaTemplate = (names) => {
...
export const renderBackendValidatorsTemplate = (names) => {
    return `import { z } from "zod";
...
export const renderBackendTypesTemplate = (names) => {
...
export const renderBackendServiceTemplate = (names) => {
...
export const renderBackendControllerTemplate = (names) => {
...
export const renderBackendRoutesTemplate = (names) => {
...
export const renderFrontendConstantsTemplate = (names) => {
...
export const renderFrontendTypesTemplate = (names) => {
...
export const renderFrontendHookTemplate = (names) => {
    return `"use client";
...
export const renderFrontendFormTemplate = (names) => {
    return `"use client";
...
export const renderFrontendTableTemplate = (names) => {
    return `"use client";
...
export const renderFrontendListPageTemplate = (names) => {
...
export const renderFrontendCreatePageTemplate = (names) => {
    const descriptions = buildDescriptions(names);
...
export const renderFrontendEditPageTemplate = (names) => {
    const descriptions = buildDescriptions(names);
    return `import { PageHeader } from "@/components/ui/page-header";
...
export const renderFrontendViewPageTemplate = (names) => {
    const descriptions = buildDescriptions(names);
    return `"use client";
...
export const renderFrontendAppListPageTemplate = (names) => {
...
export const renderFrontendAppCreatePageTemplate = (names) => {
    return `import { requirePermission } from "@/lib/server-auth";
...
export const renderFrontendAppEditPageTemplate = (names) => {
    return `import { requirePermission } from "@/lib/server-auth";
...
export const renderFrontendAppViewPageTemplate = (names) => {
    return `import { requirePermission } from "@/lib/server-auth";

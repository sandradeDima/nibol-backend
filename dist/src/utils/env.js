...
export const parseBooleanEnvValue = (value) => {
    if (value === "true")
        return true;
    if (value === "false")
        return false;
...
const envSchema = z.object({
    ...
    SMTP_SECURE: z.preprocess(parseBooleanEnvValue, z.boolean().default(false)),
...
const parsedEnv = envSchema
    ...
    if (!process.env.BETTER_AUTH_SECRET ||
        ...
        context.addIssue({
            code: "custom",
            message: "BETTER_AUTH_SECRET must be explicitly configured in production.",

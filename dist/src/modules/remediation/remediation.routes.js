...
remediationRouter.get("/observations/:id/remediation-plans", requirePermission(recommended.view), asyncHandler(remediationController.listRemediationPlans));
remediationRouter.post("/observations/:id/remediation-plans", requirePermission(recommended.create), asyncHandler(remediationController.createRemediationPlan));
remediationRouter.patch("/remediation-plans/:id", requireAnyPermission([recommended.edit, "action_plans.assign_executor"]), asyncHandler(remediationController.updateRemediationPlan));
...
remediationRouter.delete("/action-plans/:id", requirePermission("action_plans.delete"), asyncHandler(remediationController.deleteActionPlan));
remediationRouter.post("/action-plans/:id/complete", requirePermission("action_plans.evaluate"), asyncHandler(remediationController.markActionPlanComplete));
//# sourceMappingURL=remediation.routes.js.map
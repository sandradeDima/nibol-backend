...
remediationRouter.post("/observations/:id/action-plans", requireAllPermissions(["action_plans.create", "action_plans.assign"]), asyncHandler(remediationController.createActionPlan));
...
remediationRouter.post("/action-plans/:id/complete", requirePermission("action_plans.complete"), asyncHandler(remediationController.markActionPlanComplete));

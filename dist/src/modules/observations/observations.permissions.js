...
export const OBSERVATIONS_PERMISSIONS = {
    ...
    send: `${OBSERVATIONS_PERMISSION_RESOURCE}.send`,
    view: `${OBSERVATIONS_PERMISSION_RESOURCE}.view`,
};
export const OBSERVATIONS_PERMISSION_NAMES = Object.values(OBSERVATIONS_PERMISSIONS);
//# sourceMappingURL=observations.permissions.js.map
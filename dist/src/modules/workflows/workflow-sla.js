...
const weekendOnlyCalendar = (date) => {
    const day = date.getUTCDay();
    return day !== 0 && day !== 6;
};
const addBusinessDays = (startedAt, duration, calendar) => {
...
export const calculateWorkflowDeadline = (input) => {
    ...
    const calendar = input.calendar ?? { timezone: "UTC" };
    switch (input.unit) {
        case "MINUTES":
...
//# sourceMappingURL=workflow-sla.js.map
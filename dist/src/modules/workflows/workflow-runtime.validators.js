...
export const workflowTaskReassignSchema = z
    ...
    .strict()
    .refine((value) => [value.assignedAreaId, value.assignedRoleId, value.assignedUserId].filter(Boolean).length === 1, {
...
//# sourceMappingURL=workflow-runtime.validators.js.map
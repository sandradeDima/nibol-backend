...
import { EMAIL_VERIFICATION_EXPIRES_IN_SECONDS, sendVerificationEmailToUser, } from "./verification-email.js";
import { emailService } from "../../emails/EmailService.js";
const syncCredentialPassword = async (userId, password) => {
    if (!password) {
        return;
    }
            ...
            if (ctx.path === "/sign-in/email") {
                ...
                if (ctx.context.newSession) {
                    await activityLogService.logUserAction({
                        ...
                        entityType: "authentication",
                        ipAddress: ctx.context.newSession.session.ipAddress ?? ipAddress ?? null,
                        metadata: {
...
export const appendAuthHeaders = (response, headers) => {

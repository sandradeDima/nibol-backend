...
import { EXTENSION_REQUEST_ACTIVITY_ACTIONS, EXTENSION_REQUEST_ENTITY_TYPES, } from "./extension-requests.constants.js";
import { extensionRequestsService } from "./extension-requests.service.js";
import { commitmentIdParamSchema, createExtensionRequestSchema, extensionRequestIdParamSchema, listExtensionRequestsQuerySchema, observationIdParamSchema, reviewExtensionRequestSchema, updateExtensionRequestSchema, } from "./extension-requests.validators.js";
...
const getRequiredExtensionRequestId = (value) => {
...
const logMutation = async ({ action, request, summary, values, }) => {
...
export const extensionRequestsController = {
    async auditApprove(request, response) {
        const result = await extensionRequestsService.auditApprove(getRequiredExtensionRequestId(request.params.id), reviewExtensionRequestSchema.parse(request.body), getRequiredAuthorizationSummary(request));
        await logMutation({
    ...
    async auditReject(request, response) {
        const result = await extensionRequestsService.auditReject(getRequiredExtensionRequestId(request.params.id), reviewExtensionRequestSchema.parse(request.body), getRequiredAuthorizationSummary(request));
        await logMutation({
    ...
    async cancel(request, response) {
        const result = await extensionRequestsService.cancel(getRequiredExtensionRequestId(request.params.id), getRequiredAuthorizationSummary(request));
        await logMutation({
    ...
    async createForCommitment(request, response) {
        const result = await extensionRequestsService.createForCommitment(getRequiredCommitmentId(request.params.id), createExtensionRequestSchema.parse(request.body), getRequiredAuthorizationSummary(request));
        await logMutation({
    ...
    async createForObservation(request, response) {
        const result = await extensionRequestsService.createForObservation(getRequiredObservationId(request.params.id), createExtensionRequestSchema.parse(request.body), getRequiredAuthorizationSummary(request));
        await logMutation({
    ...
    async getById(request, response) {
        const result = await extensionRequestsService.getById(getRequiredExtensionRequestId(request.params.id), getRequiredAuthorizationSummary(request));
    ...
    async list(request, response) {
        ...
        const result = await extensionRequestsService.list(query, getRequiredAuthorizationSummary(request));
        sendPaginated(response, result.data, result.pagination);
    },
    async managerApprove(request, response) {
        const result = await extensionRequestsService.managerApprove(getRequiredExtensionRequestId(request.params.id), reviewExtensionRequestSchema.parse(request.body), getRequiredAuthorizationSummary(request));
        await logMutation({
    ...
    async managerReject(request, response) {
        const result = await extensionRequestsService.managerReject(getRequiredExtensionRequestId(request.params.id), reviewExtensionRequestSchema.parse(request.body), getRequiredAuthorizationSummary(request));
        await logMutation({
    ...
    async sendToAudit(request, response) {
        const result = await extensionRequestsService.sendToAudit(getRequiredExtensionRequestId(request.params.id), getRequiredAuthorizationSummary(request));
        await logMutation({
    ...
    async sendToManager(request, response) {
        const result = await extensionRequestsService.sendToManager(getRequiredExtensionRequestId(request.params.id), getRequiredAuthorizationSummary(request));
        await logMutation({
    ...
    async update(request, response) {
        const result = await extensionRequestsService.update(getRequiredExtensionRequestId(request.params.id), updateExtensionRequestSchema.parse(request.body), getRequiredAuthorizationSummary(request));
        await logMutation({

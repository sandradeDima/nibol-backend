...
export const errorMiddleware = (error, _request, response, _next) => {
    ...
    if (error instanceof ZodError) {
        ...
        const translateIssue = (issue) => {
            ...
            if (issue.code === "too_small")
                return "no alcanza el mínimo permitido.";
        ...
        const details = error.issues
            ...
            .join(" ");
        sendError(response, details
            ? `Revise los datos ingresados. ${details}`
            : "Revise los datos ingresados.", 400);
        return;
    }
    ...
    sendError(response, "Ocurrió un error interno al procesar la solicitud. Intente nuevamente y, si continúa, contacte al administrador.", 500);
};

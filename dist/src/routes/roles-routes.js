...
import { createRoleSchema, listRolesQuerySchema, roleIdParamSchema, updateRoleSchema, } from "../validators/roles-validator.js";
...
rolesRouter.get("/roles", requirePermission("roles.view"), asyncHandler(async (request, response) => {
...
rolesRouter.get("/roles/:roleId", requirePermission("roles.view"), asyncHandler(async (request, response) => {
    const role = await rolesService.getRoleById(getRequiredRoleId(request.params.roleId));
    sendSuccess(response, role);
}));
rolesRouter.post("/roles", requirePermission("roles.create"), asyncHandler(async (request, response) => {
...
rolesRouter.put("/roles/:roleId", requirePermission("roles.edit"), asyncHandler(async (request, response) => {
...
rolesRouter.delete("/roles/:roleId", requirePermission("roles.delete"), asyncHandler(async (request, response) => {

...
const parseQuery = (request) => {
    const pageSize = getQueryValue(request.query.pageSize) ??
        getQueryValue(request.query.perPage);
    return activityQuerySchema.parse({
        activityType: getQueryValue(request.query.activityType) ??
            getQueryValue(request.query["filter.activityType"]),
        actorUserId: getQueryValue(request.query.actorUserId) ??

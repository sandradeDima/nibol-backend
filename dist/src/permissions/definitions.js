...
import { ADMIN_ROLE_CODE } from "./role-codes.js";
...
export const buildPermissionName = (resource, action) => `${resource}.${action}`;
...
export const ALL_PERMISSION_NAMES = Array.from(new Set([

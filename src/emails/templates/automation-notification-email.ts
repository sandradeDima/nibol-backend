...
export const automationNotificationEmailTemplate: EmailTemplateDefinition<"automationNotification"> =
  {
    ...
    `;
      ...
      return {
        ...
        text: joinTextBlocks(
          ...
          `Fecha límite: ${variables.dueDate}`,
          `Estado actual: ${variables.currentStatus}`,
          `Acción requerida: ${variables.actionRequired}`,
          `Abrir en NIBOL: ${variables.targetUrl}`,
          `Esta es una notificación automática de ${appName}. No adjuntamos archivos de evidencia.`,
        ),
      };
    },
    sampleVariables: {
      actionRequired:
        "Ingrese al sistema y actualice el avance correspondiente.",

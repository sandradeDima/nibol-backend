...
export type ActivityActorType = "USER" | "SYSTEM" | "CRON";
export type ActivityOriginFilter = "SYSTEM" | "USER";

export type EntityActivityInput = {
  action: string;
  activityType: string;
  ...
  relatedAuditLogId?: string | null | undefined;
  targetUrl?: string | null | undefined;
  title: string;
  visibility?: string | undefined;
};

export type EntityActivityQuery = {
  ...
  includeTechnicalDetails?: boolean | undefined;
  observationCode?: string | undefined;
  observationId?: string | undefined;
  origin?: ActivityOriginFilter | undefined;
  page: number;
  pageSize: number;
...
const safeValue = (value: unknown, key?: string): Prisma.InputJsonValue | null => {
  ...
  if (typeof value === "object") {
    ...
    for (const [entryKey, entryValue] of Object.entries(value)) {
      ...
      if (sanitized !== null) result[entryKey] = sanitized;
    }
...
const resolveObservationId = async (
  entityType: string,
  entityId: string,
): Promise<string | null> => {

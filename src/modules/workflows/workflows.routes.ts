...
workflowsRouter.get(
  "/workflows/summary",
  requirePermission(WORKFLOW_PERMISSIONS.view),
  asyncHandler(workflowsController.summary),
);
...
workflowsRouter.get(
  ...
  requirePermission(WORKFLOW_PERMISSIONS.view),
  asyncHandler(workflowsController.activity),
);

workflowsRouter.get(
  "/workflows/:id/versions",
  requirePermission(WORKFLOW_PERMISSIONS.viewVersions),
  asyncHandler(workflowsController.listVersions),
);

workflowsRouter.post(
  "/workflows/:id/versions",
  requirePermission(WORKFLOW_PERMISSIONS.edit),
  asyncHandler(workflowsController.createVersion),
);
...
workflowsRouter.post(
  ...
  requirePermission(WORKFLOW_PERMISSIONS.create),
  asyncHandler(workflowsController.duplicate),
);

workflowsRouter.post(
  "/workflows/:id/archive",
  requirePermission(WORKFLOW_PERMISSIONS.archive),
  asyncHandler(workflowsController.archive),
);
...
workflowsRouter.put(
  "/workflow-versions/:versionId/designer",
  requirePermission(WORKFLOW_PERMISSIONS.edit),
  asyncHandler(workflowsController.saveDesigner),
);

workflowsRouter.post(
  "/workflow-versions/:versionId/designer/validate",
  requirePermission(WORKFLOW_PERMISSIONS.validate),
  asyncHandler(workflowsController.validateDesigner),
);

workflowsRouter.post(
  "/workflow-versions/:versionId/simulate",
  requirePermission(WORKFLOW_PERMISSIONS.simulate),
  asyncHandler(workflowsController.simulate),
);

workflowsRouter.post(
  "/workflow-versions/:versionId/publish",
  requirePermission(WORKFLOW_PERMISSIONS.publish),
  asyncHandler(workflowsController.publish),
);

export const WORKFLOW_PROCESS_TYPE_CATALOG = "workflow_process_type" as const;
...
export const WORKFLOW_CONDITION_LOGIC_VALUES = ["AND", "OR"] as const;
...
export const WORKFLOW_PROCESS_TYPE_LABELS: Record<
  (typeof WORKFLOW_PROCESS_TYPE_VALUES)[number],
  string
> = {

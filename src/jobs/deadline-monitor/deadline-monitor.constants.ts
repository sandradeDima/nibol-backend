...
export const AUTOMATIC_NOTIFICATION_TYPES = {
  actionPlanAssigned: "ACTION_PLAN_ASSIGNED",
  actionPlanCompleted: "ACTION_PLAN_COMPLETED",
  actionPlanDueSoon: "ACTION_PLAN_DUE_SOON",
  actionPlanOverdue: "ACTION_PLAN_OVERDUE",
  actionPlanReturned: "ACTION_PLAN_RETURNED",
